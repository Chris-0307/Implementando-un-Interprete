...
public class SimpleParser extends Parser {
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			{
			setState(18); match(PROGRAM);
			setState(19); match(ID);
			setState(20); match(BRACKET_OPEN);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << VAR) | (1L << PRINTLN) | (1L << IF) | (1L << ID))) != 0)) {
				{
				{
				setState(22); ((ProgramContext)_localctx).sentence = sentence();
			...
			setState(30); match(BRACKET_CLOSE);
	...
	public final SentenceContext sentence() throws RecognitionException {
		...
		try {
			...
			case PRINTLN:
				enterOuterAlt(_localctx, 1);
				{
				setState(33); ((SentenceContext)_localctx).println = println();
			...
			case IF:
				...
				{
				setState(36); ((SentenceContext)_localctx).conditional = conditional();
			...
			case VAR:
				...
				{
				setState(39); ((SentenceContext)_localctx).var_decl = var_decl();
			...
			case ID:
				...
				{
				setState(42); ((SentenceContext)_localctx).var_assign = var_assign();
	...
	public final PrintlnContext println() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(47); match(PRINTLN);
			setState(48); ((PrintlnContext)_localctx).expression = expression();
	...
	public final ConditionalContext conditional() throws RecognitionException {
		...
		try {
			...
			setState(53); match(PAR_OPEN);
			setState(54); ((ConditionalContext)_localctx).expression = expression();
			setState(55); match(PAR_CLOSE);

							List<ASTNode> body = new ArrayList<ASTNode>();
						
			setState(57); match(BRACKET_OPEN);
			setState(63);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << VAR) | (1L << PRINTLN) | (1L << IF) | (1L << ID))) != 0)) {
				{
				{
				setState(58); ((ConditionalContext)_localctx).s1 = sentence();
			...
			setState(66); match(BRACKET_CLOSE);
			setState(67); match(ELSE);

							List<ASTNode> elseBody = new ArrayList<ASTNode>();
						
			setState(69); match(BRACKET_OPEN);
			setState(75);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << VAR) | (1L << PRINTLN) | (1L << IF) | (1L << ID))) != 0)) {
				{
				{
				setState(70); ((ConditionalContext)_localctx).s2 = sentence();
			...
			setState(78); match(BRACKET_CLOSE);
	...
	public final Var_declContext var_decl() throws RecognitionException {
		...
		try {
			...
			setState(82); ((Var_declContext)_localctx).ID = match(ID);
	...
	public final Var_assignContext var_assign() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(86); ((Var_assignContext)_localctx).ID = match(ID);
			setState(87); match(ASSIGN);
			setState(88); ((Var_assignContext)_localctx).expression = expression();
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(92); ((ExpressionContext)_localctx).t1 = factor();
			...
			while (_la==PLUS) {
				...
				setState(95); ((ExpressionContext)_localctx).t2 = factor();
	...
	public final FactorContext factor() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(103); ((FactorContext)_localctx).t1 = term();
			...
			while (_la==MULT) {
				{
				{
				setState(105); match(MULT);
				setState(106); ((FactorContext)_localctx).t2 = term();
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			case NUMBER:
				enterOuterAlt(_localctx, 1);
				{
				setState(114); ((TermContext)_localctx).NUMBER = match(NUMBER);
			...
			case BOOLEAN:
				enterOuterAlt(_localctx, 2);
				{
				setState(116); ((TermContext)_localctx).BOOLEAN = match(BOOLEAN);
			...
			case ID:
				enterOuterAlt(_localctx, 3);
				{
				setState(118); ((TermContext)_localctx).ID = match(ID);
			...
			case PAR_OPEN:
				...
				setState(121); ((TermContext)_localctx).expression = expression();
				((TermContext)_localctx).node =  ((TermContext)_localctx).expression.node;
				setState(123); match(PAR_CLOSE);
				}
				break;
			default:
				throw new NoViableAltException(this);
